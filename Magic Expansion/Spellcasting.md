...
###### Techniques
In the context of Spellcasting, Techniques are groups of Defined Spells, Spell Effects, or Both. A Spellcaster will often have access to multiple Techniques, but choose to specialize in a select few. Techniques are first categorized by complexity, one of Basic, Complex, or Epic, and then by Power Source.
