...
These values are directly related to a character's [[Ability Scores]] and Combat [[Skills]].
...
`this looks weird, but the math works out? never negative, but the jumps are weird. 1 through 13 are MOD as HP, 14/15 SCR is 28/30 HP (+15/17), 16/17 SCR is 48/51 HP (+20/21), 18/19 is 68/, and so on. having at least +2 MOD is really good, and kind of the only way you dont just die? is that okay? i guess right? you need a high CON to not just die in sustained combat, and thats what CON is representing. `
...
You have a number of Hit Die equal to half your Constitution Score. Unless otherwise stated, these Hit Die are d6's. 
