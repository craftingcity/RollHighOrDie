...
`this looks weird, but the math works out? never negative, but the jumps are weird. 1 through 13 are MOD as HP, 14/15 is 28/30, 16/17 is 32/34, and so on. having at least +2 MOD is really good, and kind of the only way you dont just die? is that okay? i guess right? you need a high CON to not just die in sustained combat, and thats what CON is representing. `
