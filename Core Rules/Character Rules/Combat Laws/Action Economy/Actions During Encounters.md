...
## Timing During Initiative
##### Call for Initiative
`` call for init at top of round would likely slow combat, but is interesting...``
When *Initiative* is called, you will make a Dexterity Ability Check. This represents numerically when your character will act when compared to others during the *Encounter*.
